...
public class Player extends JComponent { // detta player objekt är en jcomponent och vi vill kunna hanter
											// knapptryckningar med en metod som heter keyPressed
	...
	public void keyMove(KeyEvent e) { // metod som hanterar knapptryckningar
		// TODO Auto-generated method stub
		...
		if (key == KeyEvent.VK_LEFT) {
			...
			x = x - 5;// minskar på x värdet för playerplattan
